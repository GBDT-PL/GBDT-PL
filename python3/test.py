...
if __name__ == "__main__":
    params = {"num_trees":100, "num_leaves":255, "min_sum_hessians":100.0, "l2_reg":0.01, "objective":"logistic",
              "learning_rate":0.1, "eval_metric":"auc", "num_classes":1, "num_threads":24, "num_bins":63, "min_gain":0.0,
              "max_var":5, "grow_by":"leaf", "leaf_type":"half_additive", "max_depth":5, "verbose":1, "sparse_ratio":0.0,
